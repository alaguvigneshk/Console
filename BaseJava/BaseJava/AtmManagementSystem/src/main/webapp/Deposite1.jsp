...
<input type="text" name="amount" pattern="[0-9]{04}" title="please enter a valid 4 digit number" minlength=4 maxlength=4>

<i class="fa-solid fa-check"></i>

<span>Enter Deposite Amount</span>
...
<input type="submit" value="Amount Deposite">
